...
const components: Components = {
  h1: ({ children }) => (
    <h1 className="mt-6 mb-3 font-heading text-xl font-semibold first:mt-0">
      {children}
    </h1>
  ),
  h2: ({ children }) => (
    <h2 className="mt-5 mb-2 font-heading text-lg font-semibold first:mt-0">
      {children}
    </h2>
  ),
  h3: ({ children }) => (
    <h3 className="mt-4 mb-2 font-heading text-base font-semibold first:mt-0">
      {children}
    </h3>
  ),
